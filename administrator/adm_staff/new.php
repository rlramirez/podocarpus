...
<main>
	<section class="modulo-servicios">
		<nav class="nav_modulo">
			<a href="nuevo.php"><i class="fas fa-user-plus"></i> Empleado</a><br>
		...
		<section class="contenido_mod">
			...
			<form method="post" action="new_e.php">
				<div class="contenedor-inputs">
					...
					<input type="text" name="address" placeholder="Domicilio" required="required">
					...
					<input type="text" name="place" placeholder="Lugar de Encargo" required="required">
					<input type="text" name="url_img" placeholder="Foto Url" required="required">
				</div>
